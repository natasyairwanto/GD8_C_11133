...
old('name', $customer->name) }}" placeholder="Masukkan Nama Customer">
                                    @error('name')
...
old('email', $customer->email) }}" placeholder="Masukkan Email Customer">
                                    @error('email')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
...
old('phone', $customer->phone) }}" placeholder="Masukkan No Telepon">
                                        @error('phone')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control @error('ticket') is-invalid @enderror" id="ticket" name="ticket">
                                        ...
                                        <option value="{{ $ticket->id }}"  {{ $ticket->id == $customer->id_ticket ? 'selected' : '' }}>
    ...
    old('quantity', $customer->quantity) }}" placeholder="Masukkan Quantity">
                                        @error('quantity')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
